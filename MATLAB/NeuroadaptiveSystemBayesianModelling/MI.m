function [mi entropy fd_bins] =  MI(x,y,fd_bins,permtest)
% This function is extracted from the book:
% Cohen, M. X. Analyzing Neural Time Series Data: Theory and Practice. 
% (The MIT Press, Cambridge, Massachusetts, 2014).
% Please see: https://github.com/mikexcohen/AnalyzingNeuralTimeSeries
...
if nargin<3 || isempty(fd_bins)
    ...
    % Change from original function to avoid too much computational load
    if fd_bins1 > 100
        fd_bins1 = 100;
    end
